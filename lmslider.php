...
function rewriteURL($content) {
    ...
    if(!wp_is_mobile())
    {
        ...
        $replaceUrl = "style='width=40px;vertical-align: middle;' target='_new' ".$pdfurl.'<img style="vertical-align: middle;" src="https://cdn3.iconfinder.com/data/icons/line-icons-set/128/1-02-128.png"/>';
